...
public class LecturerLogin extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String qry = "select * from lecturer where Name='"+username+"' and Password='"+password+"'";
        
        Statement st = con.createStatement();
        ResultSet rs = st.executeQuery(qry);
        if(rs.next()){
            //if username and password match the one in the database
            JOptionPane.showMessageDialog(this, "Welcome "+username+" You are logged in as Lecturer");
            System.out.println("Login Authenticated");
            
           LecturerPage lecp = new LecturerPage();
           lecp.show();
           dispose();
