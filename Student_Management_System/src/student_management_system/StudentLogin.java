...
public class StudentLogin extends javax.swing.JFrame {
   ...
   private String username;
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        String qry = "select * from student where tfName='"+username+"' and password='"+password+"'";
        
        Statement st = con.createStatement();
        ResultSet rs = st.executeQuery(qry);
        if(rs.next()){
            //if username and password match the one in the database
            JOptionPane.showMessageDialog(this, "Welcome "+username+" You are logged in as student");
            System.out.println("Login Authenticated");
            
           StudentPage stdp = new StudentPage();
           stdp.show();
           dispose();
